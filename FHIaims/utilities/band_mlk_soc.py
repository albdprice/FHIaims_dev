...
# example: path/band_mlk_soc.py 0 Pb Pb, would label states of Pb with an energy shift of 0
# the width of lines can also be changed, you can do it by modifying the file
# x, y ticks and labels need to be added by hand, or you can modify this file
...
############################################
	...
	for line in f:
		...
		if len(currentAtom) == len(atoms) * 2: # 12 atoms in total, current state is done, output or post process
