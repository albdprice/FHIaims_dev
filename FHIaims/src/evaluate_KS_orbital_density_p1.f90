...
!  PURPOSE
!  Subroutine evaluate_KS_orbital_density_p0 takes the local geometry and basis
...
!  ARGUMENTS
  ...
  real*8, dimension(n_max_basis_T, n_states) :: KS_vector
...
!  SOURCE
  ...
  call dgemm('N','N', max_num_calc_orb, n_points, n_compute, 1.0d0,  &
    KS_ev_compute, max_num_calc_orb, wave, n_basis_compute, &
    0.0d0, KS_orbital, max_num_calc_orb)
