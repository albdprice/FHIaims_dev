!****s* FHI-aims/evaluate_density_gradient_p1
!  NAME
!   evaluate_density_gradient_p1
!  SYNOPSIS

subroutine evaluate_density_gradient_p1 &
...
!  PURPOSE
!  Subroutine evaluate_density_gradient evaluates the gradient of the
!  charge density at one particulat point in space from the (given)
!  KS orbitals and their gradients
!
!  USES
...
end subroutine evaluate_density_gradient_p1
!---------------------------------------------------------------------
!******	
