...
subroutine get_elpa_row_col_comms_2013(MPI_COMM_WORLD, my_prow, my_pcol, mpi_comm_rows, mpi_comm_cols)
...
!  Parameters
!
!  MPI_COMM_WORLD   Global communicator for the calculations (in)
!
...
!-------------------------------------------------------------------------------
   ...
   integer, intent(in)  :: MPI_COMM_WORLD, my_prow, my_pcol
...
! --------------------------------------------------------------------------------------------------
! Please note that the following routines are outside of the module ELPA1_2013
