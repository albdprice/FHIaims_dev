...
subroutine evaluate_special_radius_x2 &
...
!
! OUTPUT
! o  special_radius  -- real number,
!            special radius of polar_freq
!
!  AUTHOR
...
!     begin work
    ...
    if (n_spin .eq. 1) then
      ...
      !polar_transform, " ")
      call diagonalize_auxmat_scalapack_real(n_basbas,polar_freq(:,:,1), &
      ...
      do i_spin = 1, n_spin 
        ...
        call diagonalize_auxmat_scalapack_real(n_basbas,polar_freq(:,:,j_spin), &
                    prodbas_threshold, n_nonsingular, eigenvalues)
    ...
    end subroutine evaluate_special_radius_x2
