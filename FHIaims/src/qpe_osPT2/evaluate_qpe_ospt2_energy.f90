!****s* FHI-aims/evaluate_qpe_ospt2_energy
!  NAME
!   evaluate_qpe_ospt2_energy
!  SYNOPSIS

      subroutine evaluate_qpe_ospt2_energy &
           (n_electrons, &
...
!  PURPOSE
!  Subroutine evaluate_qpe_ospt2_energy evaluates the correlation
...
! how to improve?
       ...
       call evaluate_ospt2_integrand(polar_freq,rpa_c_integrand,rpa_c_integrand_ss)
...
! out over frequency axis.
      ...
      if(myid.eq.0) then
        ...
        write(use_unit,'(2X,A,2X,f19.8,2X,A,f19.8,2X,A)') &
            "  OS-MP2 correlation energy :", rpa_c_energy, "Ha,", &
             rpa_c_energy*hartree, "eV"
        write(use_unit,'(2X,A,2X,f19.8,2X,A,f19.8,2X,A)') &
            "  SS-MP2 correlation energy :", rpa_c_energy_ss, "Ha,", &
...
!                 "-------------------------"
      ...
      end subroutine evaluate_qpe_ospt2_energy
