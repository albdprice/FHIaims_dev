!****s* FHI-aims/integrate_t_plus_v_matrix_p2
!  NAME
!   integrate_t_plus_v_matrix_p2
!  SYNOPSIS

subroutine integrate_t_plus_v_matrix_p2 &
     (  &
...
! First, obtain radial kinetic energy terms from  vectorized splines
              ...
              do i_spin = 1, n_spin, 1
                 call evaluate_T_plus_V_psi_p2  &
                 ( n_compute_c, n_compute_atoms, n_compute_fns, &
                   l_ylm_max, ylm_tab, one_over_dist_tab,  &
                   radial_wave, V_times_psi(1, i_point, i_spin),  &
                   local_potential_parts(i_spin), kinetic_wave, &
                   rad_index, wave_index, l_index, l_count, fn_atom, &
                   n_zero_compute, zero_index_point &
                 )
             enddo
...
!  print*, 'KS_eigenvector', KS_eigenvector
...
end subroutine integrate_t_plus_v_matrix_p2
!******
