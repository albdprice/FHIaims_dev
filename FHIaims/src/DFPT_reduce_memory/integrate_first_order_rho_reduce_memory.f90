...
subroutine integrate_first_order_rho_reduce_memory &
     (partition_tab_std, basis_l_max, KS_ev_compute, density_matrix,first_order_density_matrix, &
      max_occ_number,first_order_rho,j_atom, j_coord)
...
!  integer ld_hamiltonian  ! leading dimension of hamiltonian in calling routine
 ...
 !------------shanghui add for first_order_rho-----------------
  allocate(local_first_order_DM_rho(n_max_batch_size), STAT=info ) 
...
!----------------------------shanghui------------------------------------------             
            ...
            call  evaluate_first_order_rho_reduce_memory( &
                   ...
                   local_first_order_DM_rho, local_first_order_rho,j_atom,j_coord)
...
end subroutine integrate_first_order_rho_reduce_memory
!******
