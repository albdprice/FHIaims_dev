...
subroutine evaluate_first_order_U_reduce_memory(first_order_H, first_order_S,  &
...
!  ARGUMENTS
  ...
  real*8, dimension(n_basis, n_basis), intent(OUT) :: first_order_U
  real*8, dimension(n_basis), intent(OUT) ::  first_order_E
...
!  first_order_U 
  ...
  !--------------initialize----------------------
  first_order_U(1:n_basis,1:n_basis) = 0.0d0
...
end subroutine evaluate_first_order_U_reduce_memory
!******
