...
subroutine integrate_first_order_H_reduce_memory &
...
!shanghui: we always need gradient for DFPT_vibration. 
...
!-------End for hessian used for gga--------------------------------------
  ...
  !--------------initialize----------------------
   ...
   first_order_H(1:n_basis,1:n_basis)=0.0d0
...
!----------shanghui-gga: always calculate gradient---------------------
        ...
        do i_spin = 1, n_spin, 1
           ...
           if(use_gga) then 
           call  evaluate_first_order_gradient_rho_reduce_memory( &
           ...
           call evaluate_first_order_H_reduce_memory  &
  ...
  if(.not. use_local_index) call sync_first_order_matrix( first_order_H )
...
end subroutine integrate_first_order_H_reduce_memory
!******
