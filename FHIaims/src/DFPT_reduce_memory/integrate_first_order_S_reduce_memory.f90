...
subroutine integrate_first_order_S_reduce_memory &
...
!             endif
        ...
        ! Now add all contributions to the full first_order_S
         ...
         !endif
!----------------------------shanghui------------------------------------------             
           call evaluate_first_order_S_reduce_memory(first_order_S, partition(1), &
...
end subroutine integrate_first_order_S_reduce_memory
!******
