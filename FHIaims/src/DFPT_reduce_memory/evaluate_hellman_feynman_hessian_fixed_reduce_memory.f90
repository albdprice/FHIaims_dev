...
subroutine evaluate_hellman_feynman_hessian_fixed_reduce_memory(hellman_feynman_hessian,        &
           n_points,partition_tab, dist_tab_global, dir_tab_global,       &
           rho,first_order_rho,j_atom,j_coord)
...
!  hellman_feyman_hessian
  ...
  integer :: i_point, i_atom, i_coord
 ...
 do i_point = 1, n_points, 1
   ...
   do i_coord=1,3 
    ...
    dir_tab_global(i_coord, i_atom, i_point)/(dist_tab_global(i_atom, i_point))**5.0d0)
          else 
         hellman_feynman_hessian(i_coord,i_atom,j_coord,j_atom) =    &
         hellman_feynman_hessian(i_coord,i_atom,j_coord,j_atom) +    & 
         partition_tab(i_point)  *   &       
        ...
        +partition_tab(i_point) * rho(i_point) *                     &
       (-3.0d0*species_z(species(i_atom))*dir_tab_global(i_coord, i_atom, i_point)*  & 
    dir_tab_global(j_coord, j_atom, i_point)/(dist_tab_global(i_atom, i_point))**5.0d0)
          endif
...
end subroutine evaluate_hellman_feynman_hessian_fixed_reduce_memory
!******
