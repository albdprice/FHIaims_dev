!****s* FHI-aims/update_hartree_potential_shanghui_dielectric
!  NAME
!    update_hartree_potential_shanghui_dielectric
!  SYNOPSIS

subroutine update_hartree_potential_shanghui_dielectric &
...
end subroutine  update_hartree_potential_shanghui_dielectric
!******
