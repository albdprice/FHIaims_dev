!****s* FHI-aims/evaluate_zero_order_EDM_dielectric
!  NAME
!    evaluate_zero_order_EDM_dielectric
!  SYNOPSIS

subroutine evaluate_zero_order_EDM_dielectric&
...
end subroutine evaluate_zero_order_EDM_dielectric
!******
