!****s* FHI-aims/evaluate_wavefunc_cmplx
!  NAME
!    evaluate_wavefunc_cmplx
!  SYNOPSIS

subroutine evaluate_wavefunc_cmplx(n_points, points, i_k_point, &
&                                 use_basbas, n_bas, &
&                                 n_func, coeffs, wavefunc)

  !  PURPOSE
  !
  !    Evaluate complex-valued wave function defined by coeffs
...
end subroutine evaluate_wavefunc_cmplx
!******
