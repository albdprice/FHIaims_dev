!****s* FHI-aims/evaluate_wave_hessian_cartesian_p2
!  NAME
!    evaluate_wave_hessian_hessian_p2
!  SYNOPSIS

subroutine evaluate_wave_hessian_cartesian_p2 & 
...
!  USES
  ...
  real*8, dimension((l_wave_max+1) ** 2, 3, n_atoms_compute) :: sum_gradient
     ...
     if (current_fn .gt. 0) then
           ...
           do i_coords = 1, 3, 1
              ...
              hessian(i_compute, i_counter) = dir_tab(i_coords, compute_atom) * (dir_tab(i_coords, compute_atom) * &
                   ...
                   sum_gradient(lm_index, i_coords, compute_atom)) + & 
                   prefactor_two_diag + &
              ...
              do i_coords_2 = i_coords + 1, 3, 1
                 ...
                 hessian(i_compute, i_counter) = dir_tab(i_coords, compute_atom) * (dir_tab(i_coords_2, compute_atom) * &
                      prefactor_one + & 
                      prefactor_two * sum_gradient(lm_index, i_coords_2, compute_atom))  &
...
end subroutine evaluate_wave_hessian_cartesian_p2
!---------------------------------------------------------------------
!******
