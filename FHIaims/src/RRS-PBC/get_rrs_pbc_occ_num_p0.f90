!****s* FHI-aims/RRS-PBC/get_rrs_pbc_occ_num_p0
!  NAME
!    get_rrs_pbc_occ_num_p0
!  SYNOPSIS

subroutine get_rrs_pbc_occ_num_p0(KS_eigenvalue, n_electrons, t_out, occ_numbers, chemical_potential)

!  PURPOSE
! Subroutine get_rrs_pbc_occ_num_p0
!
...
!  integer :: i_state_2
  ...
  do i_k_points = 1, rrs_pbc_n_k_points,1
  ...
  highest_eigenvalue = KS_eigenvalue(rrs_pbc_n_states,1,1)
  do i_k_points = 1,rrs_pbc_n_k_points,1
     do i_spin = 1, rrs_pbc_n_spin, 1
        do i_state = 1, rrs_pbc_n_states, 1
  ...
  call check_rrs_pbc_norm_p0(chemical_potential_l, KS_eigenvalue, n_electrons, occ_numbers, diff_l, i_counter)
  call check_rrs_pbc_norm_p0(chemical_potential_r, KS_eigenvalue, n_electrons, occ_numbers, diff_r, i_counter)
  ...
  call zeroin_rrs_pbc_p0(chemical_potential_l, chemical_potential_r, diff_l, diff_r, fermi_acc, occupation_acc, max_zeroin, &
       rrs_pbc_n_states, KS_eigenvalue, n_electrons, chemical_potential, diff_electrons, occ_numbers, i_counter)

  !if (myid .eq. 0) then
  !    write(use_unit,*) "IGOR DEBUG ::",chemical_potential
  !    write(use_unit,*) "IGOR DEBUG1::",occ_numbers(:,1,5)
  !    write(use_unit,*) "IGOR DEBUG2::",KS_eigenvalue(:,1,5)
  !endif
  ...
  call check_rrs_pbc_norm_p0( chemical_potential, KS_eigenvalue, n_electrons, occ_numbers, diff_electrons, i_counter)
  ...
  call check_rrs_pbc_n_states(rrs_pbc_n_states, rrs_pbc_n_spin, rrs_pbc_n_k_points, occ_numbers, t_out)
...
end subroutine get_rrs_pbc_occ_num_p0
