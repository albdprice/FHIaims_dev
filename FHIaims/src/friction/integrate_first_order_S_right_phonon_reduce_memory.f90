...
subroutine integrate_first_order_S_right_phonon_reduce_memory &
...
!-----------------shanghui begin first_order_S_sparse------------------------------------------             
       call evaluate_first_order_S_right_phonon_reduce_memory & 
...
end subroutine integrate_first_order_S_right_phonon_reduce_memory
!******
