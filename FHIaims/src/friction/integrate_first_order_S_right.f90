...
subroutine integrate_first_order_S_right &
     (partition_tab_std, basis_l_max, first_order_S)
...
!  integer ld_hamiltonian  ! leading dimension of hamiltonian in calling routine
  ...
  first_order_S(3, n_atoms, n_basis,n_basis)=0.0d0
        ...
        do i_index = 1, batches_work(i_my_batch)%size, 1
           ...
           if (partition_tab(i_full_points).gt.0.d0) then
              ...
              call evaluate_waves_p2  &
                 ...
                 ! if(i_my_batch.eq.1.and.i_point.eq.2) then
                 ! bool_print=.true.
                 ! else
                 ! bool_print=.false.
                 ! endif
...
!             endif
        ...
        ! Now add all contributions to the full first_order_S
         ...
         !endif
!----------------------------shanghui------------------------------------------             
           call evaluate_first_order_S_right(first_order_S, partition(1), &
...
end subroutine integrate_first_order_S_right
!******
