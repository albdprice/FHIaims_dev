...
subroutine evaluate_rho_gradient & 
...
!  SOURCE
  ...
  metric_dpsi_dtheta_rho = ddot(l_h_dim,rho_multipole_component,1, dylm_dtheta_tab,1) / dist_tab

  metric_dpsi_dphi_rho   = ddot(l_h_dim,rho_multipole_component,1, scaled_dylm_dphi_tab,1) / dist_tab
  ...
  gradient_rho(3) = dir_tab(3) * (d_rho_multipole_dr + d_rho_free_d_r) - trigonom_tab(1) * metric_dpsi_dtheta_rho

end subroutine evaluate_rho_gradient
!---------------------------------------------------------------------
!******	
