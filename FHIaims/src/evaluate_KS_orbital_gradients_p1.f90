!****s* FHI-aims/evaluate_KS_orbital_gradients_p1
!  NAME
!   evaluate_KS_orbital_gradients_p1
!  SYNOPSIS

subroutine evaluate_KS_orbital_gradients_p1(n_points, &
     gradient_basis_wave, n_compute, &
     KS_ev_compute, max_occ_number, &
     KS_orbital_gradient, n_basis_list )

!  PURPOSE
!  Evaluates gradient of Khan Sham orbitals.
!
!  USES
...
!  local variables
  real*8, dimension(n_compute,n_points) :: aux_wave_gradient
...
!        condense and reorganize wave_gradient (this is expensive!)
     ...
     call dgemm('N','N', max_occ_number, n_points, &
       ...
       aux_wave_gradient, n_compute, 0.0d0, &
...
end subroutine evaluate_KS_orbital_gradients_p1
!---------------------------------------------------------------------
!******	
