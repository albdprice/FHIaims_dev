!****s* FHI-aims/evaluate_wavefunc_real
!  NAME
!    evaluate_wavefunc_real
!  SYNOPSIS

subroutine evaluate_wavefunc_real(n_points, points, i_k_point, &
&                                 use_basbas, n_bas, &
&                                 n_func, coeffs, wavefunc)

  !  PURPOSE
  !
  !    Evaluate real-valued wave function defined by coeffs
  ...
  if (use_basbas) then
     call evaluate_wavefunc(n_points, points, &
...
end subroutine evaluate_wavefunc_real
!******
