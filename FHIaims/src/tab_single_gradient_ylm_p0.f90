!****s* FHI-aims/tab_single_gradient_ylm_p0
!  NAME
!   tab_single_gradient_ylm_p0
!  SYNOPSIS

subroutine tab_single_gradient_ylm_p0( trigonom_tab, basis_l_max, l_ylm_max, &
     current_center, ylm_tab, dylm_dtheta_tab, scaled_dylm_dphi_tab )
...
!  INPUTS
!    o current_center -- calculated functions belong to this center
...
!       add all ylm functions from l = lmax+1 to l = lmax+1
  call increment_ylm_deriv &
       ...
       0,  &
       basis_l_max(species_center(current_center)), &
       ylm_tab, dylm_dtheta_tab, scaled_dylm_dphi_tab )

!  that's all folks

  return
end subroutine tab_single_gradient_ylm_p0
