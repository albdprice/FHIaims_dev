!****s* FHI-aims/evaluate_xc_matr_kspace
!  NAME
!   evaluate_xc_matr_kspace
!  SYNOPSIS

      subroutine evaluate_xc_matr_kspace &
...
!  PURPOSE
!  Subroutine "evaluate_xc_matr_kspace" evaluates the 
...
!     begin work
      ...
      if(myid.eq.0) then
        ...
        write(use_unit,'(2X,2A)') &
         "Start to calculate DFT xc contribution", &
...
! end loop over i_recip_point
      ...
      end subroutine evaluate_xc_matr_kspace
