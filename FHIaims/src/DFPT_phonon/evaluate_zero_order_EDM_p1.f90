!****s* FHI-aims/evaluate_zero_order_EDM_p1
!  NAME
!    evaluate_zero_order_EDM_p1
!  SYNOPSIS

subroutine evaluate_zero_order_EDM_p1 &
...
end subroutine evaluate_zero_order_EDM_p1
!******
