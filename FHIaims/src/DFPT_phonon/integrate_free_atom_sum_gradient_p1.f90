...
!****s* FHI-aims/integrate_free_atom_sum_gradient_p1
!  NAME
!   integrate_free_atom_sum_gradient_p1
!  SYNOPSIS

subroutine integrate_free_atom_sum_gradient_p1 &
...
!                                       --- shanghui 2013.12.30
!
!    change to real space first-order.  --- shanghui 2014.12.03
!
!
!  USES
...
!  ARGUMENTS
  ...
  real*8, target, dimension(3,n_centers_in_sc_DFPT,n_full_points) :: rho_free_gradient
  real*8, target, dimension(3,n_centers_in_sc_DFPT,n_full_points) :: v_free_gradient
  !------------------shanghui end add------------------------------------- 
        ...
        do i_index = 1, batches_work(i_batch)%size, 1
          ...
          if (partition_tab(i_full_points).gt.0.d0) then
           ...
           do i_coord = 1, 3
             ...
             rho_free_gradient(i_coord,i_center,i_full_points)= &
             rho_free_gradient_temp(i_coord)       
    
    
             v_free_gradient(i_coord,i_center,i_full_points)= &
...
end subroutine integrate_free_atom_sum_gradient_p1
!******
!------------------------------------------------------------------------------------------------------------
