...
!  SYNOPSIS
      ...
      subroutine ion_out &
        ( i_species, n_grid, n_wave, wave_n, wave_l, &
          r_grid, pot, wave, eigenval, descript, &
          dim_species, dim_grid, dim_fn )

!  PURPOSE
!    Subroutine ion_out outputs potential  and wave function data
...
! INPUTS 
!  o dim_species, dim_grid_dim_fn -- dimensions for other variables
!  o i_species -- ion number in question
!  o n_grid -- number of radial grid points
!  o n_wave -- number of wave functions
!  o wave_n -- quantum number
!  o wave_l -- quantum number
...
!  begin work
       ...
       if (myid.eq.0) then
          write(use_unit,*) " Writing ionic data for species ", i_species, "."
       end if
