...
! !ROUTINE: rdirac
! !INTERFACE:
subroutine rdirac(mode,sol,n,l,k,np,nr,r,vr,eval,g0,f0,max_nr)
...
!   max_np : maximum point of integration
! !DESCRIPTION:
...
! integrate the Dirac equation
  call rdiracdme(mode,sol,0,kpa,eval,np,nr,r,vr,nn,g0,g1,f0,f1,max_nr)
