...
cvb
c
c Subroutine obtained from Ricardo Gomez-Abral, which is a huge boon (writing 
c this from scratch would have been a dreadful task). 
c
c From the copyright notice below, it appears that the subroutine is in the public
c domain, but proper attribution of Levedev-Laikov (Ref. [1]) is requested. 
c
cvb end
