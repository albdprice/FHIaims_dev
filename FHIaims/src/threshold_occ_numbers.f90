...
!
      ...
      subroutine threshold_occ_numbers &
        ( n_electrons, occ_numbers, diff_electrons_thr &
        )
...
!  counter
      ...
      diff_electrons_thr = temp_n_electrons - n_electrons

      end subroutine threshold_occ_numbers
