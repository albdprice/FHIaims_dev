!****s* FHI-aims/tab_single_trigonom_p0
!  NAME
!   tab_single_trigonom_p0
!  SYNOPSIS

subroutine tab_single_trigonom_p0( dir_tab, trigonom_tab )
...
!       next, out-of-xy-plane vector theta
  ...
  if (abcmax .gt. 0.0d+0) then
     ...
     ! This piece of code is used in the periodic force calculations.

     trigonom_tab(2) = 0.0d+0
     trigonom_tab(1) = 1.0d+0

  endif

!  that's it

end subroutine tab_single_trigonom_p0
!----------------------------------------------------------------------
!******
