...
!  SYNOPSIS
      ...
      subroutine diagonalize_auxmat_lapack &
      ( n_basbas, auxmat, safe_minimum, threshold, &
...
!     auxmat_transform: Non-singular eigenvectors of the ovlp matrix
      ...
      real*8 auxmat_transform(n_basbas,n_basbas)
...
!  that's all folks
      ...
      end subroutine diagonalize_auxmat_lapack
!-----------------------------------------------------------------------
!******
