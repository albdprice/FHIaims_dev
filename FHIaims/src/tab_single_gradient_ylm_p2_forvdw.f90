...
! Copy of tab_single_gradient_ylm_p2.f90 for use in get_rho_mp4.f90 only.
! SAG

subroutine tab_single_gradient_ylm_p2_forvdw & 
...
!       add all ylm functions from l = lmax+1 to l = lmax+1
  call increment_ylm_deriv_forvdw &
...
!  that's all folks
  ...
  return
end subroutine tab_single_gradient_ylm_p2_forvdw
