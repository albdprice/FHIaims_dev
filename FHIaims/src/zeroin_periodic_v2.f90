...
!******
!-------------------------------------------------------------------------------
!****s* force_occupation/zeroin_periodic_v2
!  NAME
!    zeroin_periodic_v2
!  SYNOPSIS
...
!
!   Copyright: My impression is that these routines come with a liberal (if nonexistent)
...
!
      subroutine zeroin_periodic_v2(ax, bx, fax, fbx, tol, &
...
!  140 fb=f(b)
 140  continue
      call check_norm_periodic_v2(b, KS_eigenvalue, n_electrons, &
...
!       force end despite non-convergence
  ...
  150 chemical_potential = b
      ...
      end subroutine zeroin_periodic_v2
