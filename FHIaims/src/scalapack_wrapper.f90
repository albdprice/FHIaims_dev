...
!-------------------------------------------------------------------------------
  ...
  public :: construct_first_order_dm_polar_scalapack
  public :: get_first_order_dm_polar_scalapack
  public :: construct_first_order_ham_polar_scalapack
  public :: evaluate_first_order_U_polar_scalapack
...
! SOURCE
    ...
    ! VY: If block_size is defined in control.in file, check it here.
