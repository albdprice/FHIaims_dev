!****s* FHI-aims/integrate_first_order_S_p0
!  NAME
!   integrate_first_order_S_p0
!  SYNOPSIS

subroutine integrate_first_order_S_p0 &
...
!----------------------------shanghui------------------------------------------             
           call evaluate_first_order_S_p0(first_order_S,n_points, partition(1:n_points), &
                             n_compute_c,i_basis,   & 
...
end subroutine integrate_first_order_S_p0
!******
