...
!****s* FHI-aims/integrate_free_atom_hessian_p0
!  NAME
!   integrate_free_atom_hessian_p0
!  SYNOPSIS

subroutine integrate_free_atom_hessian_p0 &
...
!  ARGUMENTS
  ...
  real*8, dimension(3, n_atoms, 3, n_atoms)          ::  hellman_feynman_hessian_free_part
...
!  SOURCE
            ...
            if(dist_tab_sq.lt.multipole_radius_free_sq(species(current_spl_atom))) then
               ...
               call tab_single_radial_weights_v2 &
                 ...
                 ! hartree_free_2nd_deriv = d^2 V_free(|r-R|)/ d|r-R|^2
                  ...
                  hellman_feynman_hessian_free_part(i_coord,center_to_atom(current_center),j_coord,i_atom_2)= & 
                  hellman_feynman_hessian_free_part(i_coord,center_to_atom(current_center),j_coord,i_atom_2)- & 
  ...
  !-------shanghui begin parallel------  
   call sync_vector(hellman_feynman_hessian_free_part,3*n_atoms*3*n_atoms)
...
end subroutine  integrate_free_atom_hessian_p0
!******
!------------------------------------------------------------------------------------------------------------
