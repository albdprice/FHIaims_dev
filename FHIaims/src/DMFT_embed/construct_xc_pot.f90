...
subroutine construct_xc_pot(xc_pot, xc_pot_w, &
     xc_pot_w_complex, k_point,work_xc)
  ...
  use runtime_choices
  use basis
  use mpi_tasks, only: n_tasks, aims_stop, check_allocation
  use localorb_io, only: localorb_info
  implicit none

  !  ARGUMENTS

  real*8::     xc_pot ( n_hamiltonian_matrix_size,n_spin )
  real*8::     xc_pot_w         ( n_basis*(n_basis+1)/2,n_spin)
  complex*16:: xc_pot_w_complex ( n_basis*(n_basis+1)/2,n_spin)
  real*8, dimension( n_centers_basis_I , n_centers_basis_I,n_spin ),optional :: work_xc
  integer:: k_point
              ...
              do i_size = index_hamiltonian(1,i_cell, i_basis_2),index_hamiltonian(2,i_cell, i_basis_2)
                 ...
                 if(real_eigenvectors)then
                    ...
                    do i_spin = 1, n_spin
                       ...
                       xc_pot_w(index_b(i_basis_1,i_basis_2) ,i_spin) =  &
                            xc_pot_w(index_b(i_basis_1,i_basis_2),i_spin) &
                            + dble(k_phase( i_cell,k_point))*  &
                             xc_pot(  i_index_real , i_spin)
                    end do
                    ...
                    do i_spin = 1, n_spin
                       ...
                       xc_pot_w_complex(index_b(i_basis_1,i_basis_2) ,i_spin) = &
                            xc_pot_w_complex(index_b(i_basis_1,i_basis_2),i_spin) &
     ...
     if(real_eigenvectors)then
              ...
              if(i_index_new /= 0 .and.  i_index_old /= 0)then
                 ...
                 if(real_eigenvectors)then
                    ...
                    do i_spin = 1, n_spin
                      ...
                      xc_pot_w(i_index_new,i_spin) =    xc_pot_w(i_index_new,i_spin)   &
        ...
        if(k_point <= n_tasks)then
           ...
           do i_spin = 1, n_spin
              ...
              do i_basis_1 = 1,n_centers_basis_I,1 
                 ...
                 work_xc(1:i_basis_1, i_basis_1,i_spin) =  xc_pot( index_b_old( 1:i_basis_1, i_basis_1),i_spin)
        ...
        do i_spin = 1,n_spin
           ...
           do i_basis_2 = 1,n_basis
              ...
              xc_pot_w_complex( index_b_new( 1:i_basis_2, i_basis_2) ,i_spin) =  &
...
end subroutine construct_xc_pot
!******
