  subroutine get_density_matr(embed_gf,&
                              embed_dens_matr, &
...
!                  (real(embed_gf(i_matrix_size,j_matrix_size, i_freq))*cos((omega(i_freq))*(3.1321E-4))&! for grid with 200 points
!                 -aimag(embed_gf(i_matrix_size,j_matrix_size, i_freq))*sin((omega(i_freq))*(3.1321E-4)))!*exp(-chemical_potential*(4.1023E-5)) ! for grid with 200 points
!                  (real(embed_gf(i_matrix_size,j_matrix_size, i_freq))*cos((omega(i_freq))*(2.8621E-4))&! for grid with 200 points
!                 -aimag(embed_gf(i_matrix_size,j_matrix_size, i_freq))*sin((omega(i_freq))*(2.8621E-4)))!*exp(-chemical_potential*(4.1023E-5)) ! for grid with 200 points
...
!                  ((sin(omega(i_freq)*(2.8621E-4)))*(omega(i_freq)**(-1))) ! for grid with 200 points
                  ((sin(omega(i_freq)*(3.3523E-4)))*(omega(i_freq)**(-1))) ! for grid with 200 points
...
!              write(use_unit,*) 'sin() fct. Calibration',  sin_anteil_calibrate, pi/2
...
!----------------------------------------------------------------------------------------------------------------------------------------------
  ...
  end subroutine get_density_matr 
