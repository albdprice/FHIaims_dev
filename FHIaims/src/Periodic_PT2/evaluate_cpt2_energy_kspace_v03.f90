...
!     n_first : the first orbital which is NOT fully occupied
      ...
      integer, parameter :: request_o3fn_k   = 101
      integer, parameter :: request_o3fn_kp  = 102
      integer, parameter :: request_o3fn_q   = 103
      integer, parameter :: request_o3fn_qp  = 104
      integer, parameter :: request_eigen_k  = 201
      integer, parameter :: request_eigen_kp = 202
      integer, parameter :: request_eigen_q  = 203
      integer, parameter :: request_eigen_qp = 204
      integer, parameter :: request_c_qk     = 301
      integer, parameter :: request_c_qpk    = 302
