!****s* FHI-aims/evaluate_second_order_S_fixed
!  NAME
!    evaluate_second_order_S_fixed
!  SYNOPSIS

subroutine evaluate_second_order_S_fixed(second_order_S, partition_tab, &
...
end subroutine evaluate_second_order_S_fixed
!******
