C JW, 2010-07-03:
C     * Commented out calls to xermsg().  There is IER anyway.
C     * Added f2py directives
C
*DECK DRC3JJ
...
C
Cf2py double precision, intent(IN) :: L2, L3, M2, M3
Cf2py integer, intent(IN), optional :: NDIM = L2+L3 - max(abs(L2-L3), abs(M2+M3)) + 1
Cf2py double precision, intent(OUT) :: L1MIN, L1MAX
Cf2py double precision, intent(OUT) :: THRCOF(NDIM)
Cf2py integer, intent(OUT) :: IER
      INTEGER NDIM, IER
