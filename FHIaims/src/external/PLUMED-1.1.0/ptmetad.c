...
// calculating the bias and walls
  assert(all_ss0[newrepl]);
  local_bias=hills_engine(colvar.ss0,NULL)+soft_walls_engine(colvar.ss0,NULL);
  local_biasx=hills_engine(all_ss0[newrepl],NULL)+soft_walls_engine(all_ss0[newrepl],NULL);
