...
C
Cf2py double precision, intent(IN) :: L1, L2, L3, M1
Cf2py integer, intent(IN), optional :: NDIM = min(L2,L3-M1) - max(-L2,-L3-M1) + 1
Cf2py double precision, intent(OUT) :: M2MIN, M2MAX
