...
#elif defined (ACEMD) || defined (AMBER) || defined (DRIVER) || defined (STANDALONE) || defined (PLUMED_QESPRESSO) || defined (FHIAIMS)
   int  imcon;
   real cell[3];
...
#define oprod cprod
 ...
 void init_metadyn__(int *atoms, real *ddt, real *mass, real *charge, int *imcon, real *eunit, char *metain, int pp);
