...
#if ! defined (PLUMED_GROMACS) && ! defined (DL_POLY) && ! defined (AMBER) && ! defined (FHIAIMS)
...
#ifdef FHIAIMS
       plumed_error("ELSTPOT CV: NOT YET IMPLEMENTED IN THIS CODE. ASK DEVELOPERS IF YOU ARE INTERESTED ");	
#endif
...
#if ! defined (PLUMED_GROMACS4) && ! defined (DL_POLY) && ! defined (AMBER) && ! defined (PLUMED_GROMACS45) && ! defined (FHIAIMS) 
