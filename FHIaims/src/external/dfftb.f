      ...
      INTEGER NF, NA, L1, L2, IDO, IDL1, I, IP, IW, IX2, IX3, IX4, K1
      NF = INT(IFAC(2))
      NA = 0
      L1 = 1
      IW = 1
...
C     *** TR12=COS(4*PI/5), TI12=SIN(4*PI/5)      
  ...
  103 CONTINUE
      ...
      REAL*8 CC, C1, C2, CH, CH2, WA
      DIMENSION       CH(IDO,L1,IP)          ,CC(IDO,IP,L1)          ,
     1                C1(IDO,L1,IP)          ,C2(IDL1,IP),
     2                CH2(IDL1,IP)           ,WA(*)
      DATA TPI/6.28318530717958647692D0/
      INTEGER I, IC, IDIJ, IDP2, IK, IPP2, IPPH, IS, J, J2, JC, K, L, LC
      INTEGER NBD 
      ARG = TPI/FLOAT(IP)
      DCP = COS(ARG)
      DSP = SIN(ARG)
