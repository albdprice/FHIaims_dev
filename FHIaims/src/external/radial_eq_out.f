...
C
C  Test: This is a test version which simply integrates the radial equation outward.
C        No proper normalisation.
C
c  Header:
c***********************************************************************
c
...
c       l .ne. 0: nonrel. solution starts as r**(l+1) (e.g. Cohen-Tannoudji)
c       l=0: do hydrogen-like start (improves eigenvalues and wavefunctions)

        do i=1,4

          if(l .eq. 0 .and. imod .eq. 2 .or. imod .eq. 1) then
c           simply add the first few terms of exp(-zr) from actual H-like wave function
