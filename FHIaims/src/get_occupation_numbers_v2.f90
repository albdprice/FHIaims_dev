!****s* FHI-aims/get_occupation_numbers_v2
!  NAME
!   get_occupation_numbers_v2
!  SYNOPSIS

subroutine get_occupation_numbers_v2(KS_eigenvalue, n_electrons, t_out, occ_numbers, chemical_potential)
...
!  SOURCE
  ...
  call check_norm_v2(chemical_potential_l, KS_eigenvalue, n_electrons, occ_numbers, diff_l, i_counter)
  call check_norm_v2(chemical_potential_r, KS_eigenvalue, n_electrons, occ_numbers, diff_r, i_counter)
  ...
  call zeroin_v2(chemical_potential_l, chemical_potential_r, diff_l, diff_r, fermi_acc, occupation_acc, max_zeroin, &
  ...
  call check_norm_v2( chemical_potential, KS_eigenvalue, n_electrons, occ_numbers, diff_electrons, i_counter)
  ...
  call check_n_states(n_states, 1, 1, occ_numbers, t_out)
...
end subroutine get_occupation_numbers_v2
