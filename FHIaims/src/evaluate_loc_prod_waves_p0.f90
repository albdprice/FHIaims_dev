!****s* FHI-aims/evaluate_loc_prod_wave_p0
!  NAME
!   evaluate_loc_prod_wave_p0
!  SYNOPSIS

      subroutine evaluate_loc_prod_wave_p0 &
...
!  PURPOSE
!     Subroutine evaluate_loc_prod_wave
...
!  ARGUMENTS
      ...
      real*8  ::  loc_prod_wave(n_loc_compute)
...
!  OUTPUTS
!  o  loc_prod_wave -- the value of the integral over the bare Coulomb interaction 
...
!         wave function value from basis_atom at current integration point
          ...
          loc_radial_prod_wave = &
          val_spline &
          ( i_r(i_atom), &
            basbas_wave_spl(1,1,basbas_fn(i_index)), &
...
!test end
      ...
      end subroutine evaluate_loc_prod_wave_p0
!---------------------------------------------------------------------
!******
