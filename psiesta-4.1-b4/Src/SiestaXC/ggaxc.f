...
C *********************************************************************
C Implements Becke B86b (exchange) and Perdew-Burke-Ernzerhof PBE (correlation).
C Ref: A.D. Becke, JCP 85, 7184 (1986) and J.P. Perdew, K. Burke & M. Ernzerhof, PRL 77, 3865 (1996)
C Adpated from PBEformXC SUBROUTINE by Luc M. LeBlanc. June 2019.
C ********************************************************************
...
C Redefine MU and KAPPA parameters for B86b exchange functional
...
C *********************************************************************
C Implements Becke B88 (exchange) and Perdew-Burke-Ernzerhof PBE (correlation).
C Ref: A.D. Becke, PRA 38, 3098 (1988) and J.P. Perdew, K. Burke & M. Ernzerhof, PRL 77, 3865 (1996)
C Adpated from PBEformXC SUBROUTINE by Luc M. LeBlanc. June 2019.
C ********************************************************************
...
C Internal variables
     ...
     .  IS, IX
      real(dp)
     .  A, C, BETA, D(2), DADD, DECUDD, DENMIN, 
     .  DF1DD, DF2DD, DF3DD, DF4DD, DF1DGD, DF3DGD, DF4DGD,
     .  DFCDD(2), DFCDGD(3,2), DFDD, DFDGD, DFDS, DF1DS, DFXDD(2),
     .  DFXDGD(3,2), DHDD, DHDGD, DKFDD, DKSDD, DPDD, DPDZ, DRSDD, 
     .  DS(2), DSDD, DSDGD, DT, DTDD, DTDGD, DZDD(2), 
...
C Call B88 routine with appropriate values for BETA, MU, and C.
      CALL B88formX( BETA, MU, C, IREL, nspin, Dens, GDens,
     .               EX, DEXDD, DEXDGD )
