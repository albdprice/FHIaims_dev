...
!
!   (For the latter there are two new, simpler versions:
!   setxc_family_authors(family,authors)
!   setxc_libxc_ids(nfuncs,libxc_ids)
!   )
!
...
! set to double precision, but it can be turned to single precision
! by compiling with -DGRID_SP
...
!        'B86BPBE' => GGA Becke, JCP 85, 7184 (1986); Perdew, Burke & Ernzerhof, PRL 77, 3865 (1996)
! ^LML
!        'B88PBE'  => GGA Becke, PRA 38, 3098 (1988); Perdew, Burke & Ernzerhof, PRL 77, 3865 (1996)
! ^LML
