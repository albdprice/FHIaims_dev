...
"mpif90 -O2 -fPIC -ftree-vectorize -march=native"
character(len=*), parameter :: fppflags= &
" -DMPI -DMPI_TIMING -DFC_HAVE_FLUSH -DFC_HAVE_ABORT -DGRID_DP -DPHI_GRID_SP -DCDF"
character(len=*), parameter :: libs= &
"libfdict.a -L/cvmfs/soft.computecanada.ca/easybuild/software/2017/avx512/Compiler/intel2018.3/netcdf-fortran/4.4.4/lib -lnetcdff -lmkl_scalapack_lp64 -lmkl_blacs_openmpi_lp64 -mkl=sequential -mkl=sequential -mkl=sequential  libfdict.a -qopenmp -lhdf5_fortran -lhdf5 -lz"
