...
BLACS_LIBS = -lmkl_blacs_openmpi_lp64 -mkl=sequential
...
FPPFLAGS = $(DEFS_PREFIX) -DMPI -DMPI_TIMING -DFC_HAVE_FLUSH -DFC_HAVE_ABORT -DGRID_DP -DPHI_GRID_SP -DCDF
...
#
LIBS = $(NETCDF_LIBS) $(SCALAPACK_LIBS) $(BLACS_LIBS) $(LAPACK_LIBS) $(BLAS_LIBS) $(MPI_LIBS) $(COMP_LIBS) -qopenmp -lhdf5_fortran -lhdf5 -lz
...
# to work with VPATH.
#
FFLAGS_DEBUG = -g -O0 -qopenmp   # your appropriate flags here...
